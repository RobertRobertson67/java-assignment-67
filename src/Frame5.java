...
public class Frame5 extends javax.swing.JFrame {
    ...
    public Frame5() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowActivated(WindowEvent e) {
                ...
                jLabel1.setText("Scenerio 5: " + Main_Menu.cases[4].getCaseTitle());
                jTextArea2.setText(Main_Menu.cases[4].getCaseDescription());
                jLabel2.setText("Category: " + Main_Menu.cases[4].getCategory());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Main_Menu.cases[4].verdict.setCaseName(Main_Menu.cases[4].getCaseTitle());
        ...
        if (jRadioButton1.isSelected()){
            decision = Results.ETHICAL;
        } else if (jRadioButton2.isSelected()){
            decision = Results.UNETHICAL;
        }
        //Set the object by calling another method from cases to get decision
        Main_Menu.cases[4].verdict.setStudentVerdict(decision);
        
        //Set the object by getting user input text to get reason
        Main_Menu.cases[4].verdict.setReason(jTextArea1.getText());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        System.out.println(EthicsCase.getHelp(Main_Menu.cases[4]));
